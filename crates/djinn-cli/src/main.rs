...
use promotion_candidate::{
    candidate_string_array_value, candidate_string_value, parse_promotion_candidate,
    promotion_candidate_paths, promotion_todo_adapter, resolve_promotion_candidates,
    validate_promotion_candidate_path, PromotionCandidate,
};
#[cfg(test)]
...
use session_status::{
    ...
    SessionStatusCandidateEntry, SessionStatusCandidateReport, SessionStatusFileReport,
    SessionStatusReport,
};
#[cfg(test)]
