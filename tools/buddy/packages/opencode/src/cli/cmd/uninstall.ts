...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall buddy and remove all related files",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      npm: "npm uninstall -g buddy-ai",
      pnpm: "pnpm uninstall -g buddy-ai",
      bun: "bun remove -g buddy-ai",
      yarn: "yarn global remove buddy-ai",
      brew: "brew uninstall buddy",
      choco: "choco uninstall buddy",
      scoop: "scoop uninstall buddy",
    }
